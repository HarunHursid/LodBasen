...
public partial class lodbasen_dk_db_lodbasenContext : DbContext
{
    ...
    public virtual DbSet<Leder> Leders { get; set; }

    public virtual DbSet<Lodsalg> Lodsalgs { get; set; }

    public virtual DbSet<Lodseddel> Lodseddels { get; set; }

    public virtual DbSet<Modtager> Modtagers { get; set; }

    public virtual DbSet<Sælger> Sælgers { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=mssql5.unoeuro.com;Initial Catalog=lodbasen_dk_db_lodbasen;Persist Security Info=True;User ID=lodbasen_dk;Password=ne2GgdbHy3DEmrkAFwtx");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Barn>(entity =>
        {
            ...
            entity.HasOne(d => d.Gruppe).WithMany(p => p.Barns)
        ...
        modelBuilder.Entity<Leder>(entity =>
        {
            ...
            entity.HasOne(d => d.Gruppe).WithMany(p => p.Leders)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Lodsalg>(entity =>
        {
            ...
            entity.HasOne(d => d.Lodseddel).WithMany(p => p.Lodsalgs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Lodsalg__Lodsedd__339FAB6E");

            entity.HasOne(d => d.Modtager).WithMany(p => p.Lodsalgs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Lodsalg__Modtage__32AB8735");

            entity.HasOne(d => d.Sælger).WithMany(p => p.Lodsalgs)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Modtager>(entity =>
        {
            ...
            entity.HasOne(d => d.Barn).WithMany(p => p.Modtagers).HasConstraintName("FK__Modtager__Barn_I__2B0A656D");

            entity.HasOne(d => d.Leder).WithMany(p => p.Modtagers).HasConstraintName("FK__Modtager__Leder___2A164134");
        });
        ...
        modelBuilder.Entity<Sælger>(entity =>
        {
            ...
            entity.HasOne(d => d.Admin).WithMany(p => p.Sælgers).HasConstraintName("FK__Sælger__Admin_ID__2EDAF651");

            entity.HasOne(d => d.Leder).WithMany(p => p.Sælgers).HasConstraintName("FK__Sælger__Leder_ID__2DE6D218");
        });
